...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (email: string, password: string, metadata?: Record<string, string | undefined>) => {
    // Clean metadata: remove undefined/empty values to prevent "undefined" strings in DB
    ...
    // Supabase may return success with empty identities when user already exists
